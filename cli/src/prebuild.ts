...
const getLibraryDocsData = (): LibraryDocData[] => {
    const data: LibraryDocData[] = fs
        .readdirSync(LIBRARY_FOLDER)
...
const sortLibraryDocs = (pages: LibraryDocData[]): LibraryDocData[] => {
    return pages.sort((a, b) => {
        if (a.text === 'Readme') return -1
